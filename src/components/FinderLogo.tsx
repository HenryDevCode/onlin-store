...
const styles = {
  svgPath1: { fill: colors.primary },
  svgPath2: { fill: "white" },
  svgPath3: { fill: colors.finderTypography },
  svgPath4: { fill: colors.primary }
};
